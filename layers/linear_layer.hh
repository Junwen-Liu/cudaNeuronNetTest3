...
// for unit testing purposes only, allow this class to be used in multiple namespace
namespace {
...
public:
	...
	//a friend class can access private and protected members of other class in which it declared as friend
